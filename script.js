        ...
        $(document).ready(function () {
            $("#btnSave").on("click", function () {
                ...
                if (isValid) {
                    $(".data-table tbody").append("<tr data-name='" + name + "' data-email='" + email + "' data-city='" + address + "' data-phone='" + phone + "' data-gender='" + gender + "' data-age='" + age + "'><td>" + name + "</td><td>" + email + "</td><td>" + address + "</td><td>" + phone + "</td><td>" + gender + "</td><td>" + age + "</td><td><button class='btn btn-danger btn-lg btn-delete mr-3' type='button'>Delete</button><button class='btn btn-info btn-lg btn-edit' type='button'>Edit</button></td></tr>");
            ...
            $('body').on('click', '.btn-edit', function () {
                ...
                var address = $(this).parents('tr').attr('data-city');
                ...
                $(this).parents('tr').find('td:eq(2)').html("<input name='edit_city' value='" + address + "'>");
            ...
            $('body').on('click', '.btn-update', function () {
                ...
                var address = $(this).parents('tr').find("input[name='edit_city']").val();
                ...
                $(this).parents('tr').attr('data-city', address);
